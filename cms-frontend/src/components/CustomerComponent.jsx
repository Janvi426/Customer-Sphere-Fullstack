...
const CustomerComponent = () => {
      ...
      function saveOrUpdateCusmoter(e) {
         e.preventDefault();
         ...
         <div className="card col-md-6 offset-md-3 offset-md-3">
            ...
            <div className="card-body">
               <form>
                  ...
                  <button className='btn btn-success' onClick={saveOrUpdateCusmoter}>Submit</button>
                  <Link to="/customers" className='btn btn-danger ms-2'>Cancel</Link>
               </form>
            </div>
         </div>
      </div>
